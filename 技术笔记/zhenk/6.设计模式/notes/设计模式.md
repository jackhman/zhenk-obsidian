...
![[AbstractFactory抽象工厂模式UML图.png]]
### Builder构建者模式
![[Builder构建者模式UML图.png]]
### Factory Method工厂方法模式
![[Factory Method工厂方法模式UML图.png]]
### Prototype原型模式
![[Prototype原型模式UML图.png]]
### Singleton单例模式
![[Singleton单例模式UML图.png]]


## 构造型模式(7)
扩展结构
### Adapter适配器模式
![[Adapter适配器模式UML图.png]]
### Bridge桥接模式
![[Bridge桥接模式UML图.png]]
### Composite组合者模式
![[Composite组合者模式UML图.png]]
### Decorator装饰者模式
![[Decorator装饰者模式UML图.png]]
### Facade外观者模式
![[Facade外观者模式UML图.png]]
### Flyweight享元模式
![[Flyweight享元模式UML图.png]]
### Proxy代理模式
![[Proxy代理模式UML图.png]]
...
![[Command命令模式UML图.png]]
### Interpreter解释器模式
![[Interpreter解释器模式UML图.png]]

![[Interpreter解释器模式UML图详细介绍.png]]

### Iterator迭代器模式
![[Iterator迭代器模式UML图.png]]
### Mediator中介者模式
![[Mediator中介者模式UML图.png]]
### Memento备忘录模式
![[Memento备忘录模式UML图.png]]
### Observer观察者模式
![[Observer观察者模式UML图.png]]
### State状态模式
![[State状态模式UML图.png]]
### Strategy策略模式
![[Strategy策略模式UML图.png]]
### Template Method模板方法模式
![[Template Method模板方法模式UML图.png]]
### Visitor访问者模式
![[Visitor访问者模式UML图.png]]

### Null Object空对象模式
![[Null Object空对象模式UML图.png]]

# 总览
|                                                           图解                                                           |                  设计模式                  |                                 简述                                 |      一句话归纳       |     目的      |    生活案例     |
| :--------------------------------------------------------------------------------------------------------------------: | :------------------------------------: | :----------------------------------------------------------------: | :--------------: | :---------: | :---------: |
| ![1701757598733](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757598733.png>) |         工厂模式（Factory Pattern）          |                            不同条件下创建不同实例                             |   产品标准化，生产更高效    |   封装创建细节    |    实体工厂     |
| ![1701757541716](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757541716.png>) |         抽象工厂（Factory Pattern）          |                        提供一个创建一组相关或相互依赖对象的接口                        |   产品标准化，生产更高效    |   封装创建细节    |    实体工厂     |
| ![1701757614399](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757614399.png>) |        单例模式（Singleton Pattern）         |                      保证一个类仅有一个实例，并且提供一个全局访问点                       |     世上只有一个我      |   保证独一无二    |     CEO     |
| ![1701757655273](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757655273.png>) |        原型模式（Prototype Pattern）         |                            通过拷贝原型创建新的对象                            |   拔一根猴毛，吹出千万个    |   高效创建对象    |     克隆      |
| ![1701757675093](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757675093.png>) |         建造者模式（Builder Pattern）         |                            用来创建复杂的复合对象                             | 高配中配和低配，想选哪配就哪配  |  开放个性配置步骤   |     选配      |
| ![1701757741231](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757741231.png>) |          代理模式（Proxy Pattern）           |                       为其他对象提供一种代理以控制对这个对象的访问                       | 没有资源没时间，得找别人来帮忙  |    增强职责     |     媒婆      |
| ![1701757751037](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757751037.png>) |          外观模式（Facade Pattern）          |                         对外提供一个统一的接口用来访问子系统                         |   打开一扇门，通向全世界    |   统一访问入口    |    slf4j    |
| ![1701757763887](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757763887.png>) |        装饰器模式（Decorator Pattern）        |                              为对象添加新功能                              |    他大舅他二舅都是他舅    |  灵活扩展、同宗同源  | JAVA IO ,奶茶 |
| ![1701757775651](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757775651.png>) |        享元模式（Flyweight Pattern）         |                          使用对象池来减少重复对象的创建                           |  优化资源配置，减少重复浪费   |    共享资源池    |   数据库连接池    |
| ![1701757787136](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757787136.png>) |        组合模式（Composite Pattern）         |               将整体与局部（树形结构）进行递归组合，让客户端能够以一种的方式对其进行处理                | 人在一起叫团伙，心在一起叫团队  |   统一整体和个体   |    组织架构树    |
| ![1701757796122](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757796122.png>) |         适配器模式（Adapter Pattern）         |                          将原来不兼容的两个类融合在一起                           |      万能充电器       |    兼容转换     |    电源适配     |
| ![1701757805486](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757805486.png>) |          桥接模式（Bridge Pattern）          |                          将两个能够独立变化的部分分离开来                          |      约定优于配置      |   不允许用继承    |      桥      |
| ![1701757827844](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757827844.png>) |         模板模式（Template Pattern）         |                       定义一套流程模板，根据需要实现模板中的操作                        | 流程全部标准化，需要微调请覆盖  |    逻辑复用     |   把大象装进冰箱   |
| ![1701757840931](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757840931.png>) |         策略模式（Strategy Pattern）         |                         封装不同的算法，算法之间能互相替换                          | 条条大道通罗马，具体哪条你来定  |  把选择权交给用户   |   选择支付方式    |
| ![1701757851984](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757851984.png>) | 责任链模式（Chain of Responsibility Pattern） | 拦截的类都实现统一接口，每个接收者都包含对下一个接收者的引用。将这些对象连接成一条链，并且沿着这条链传递请求，直到有对象处理它为止。 |  各人自扫门前雪，莫管他们上霜  |   解耦处理逻辑    |     踢皮球     |
| ![1701757865048](<D:\Documents\学习\000 Note\zhenk-obsidian\技术笔记\zhenk\6.设计模式\notes\imag\设计模式\模式总结表格\1701757865048.png>) |         迭代器模式（Iterator Pattern         |                       提供一种方法顺序访问一个聚合对象中的各个元素                       | 流水线上坐一天，每个包裹扫一遍  | 统一对集合的访问方式  |   逐个检票进站    |
