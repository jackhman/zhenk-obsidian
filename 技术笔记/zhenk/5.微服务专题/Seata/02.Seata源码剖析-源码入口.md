> 抄的CSDN([Seata源码学习（二）-源码入口\_globaltransactionautoconfiguration在哪个地方-CSDN博客](https://blog.csdn.net/qq_27566167/article/details/129033605))上的，因为我觉得他写的好，没必要再写一遍
## Seata客户端启动
